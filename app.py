...
import pandas as pd
                                        ...
                                        ## To Add External CSS ##
with open('C:\\Users\\user\\Desktop\\medi\\medicine-recommendation-system\\css\\style.css') as f:
     st.markdown(f'<style>{f.read()}</style>', unsafe_allow_html=True)



                    # To load medicine-dataframe from pickle in the form of dictionary
medicines_dict = pickle.load(open('C:\\Users\\user\\Desktop\\medi\\medicine-recommendation-system\\medicine_dict.pkl','rb'))
medicines = pd.DataFrame(medicines_dict)

                    # To load similarity-vector-data from pickle in the form of dictionary
similarity = pickle.load(open('C:\\Users\\user\\Desktop\\medi\\medicine-recommendation-system\\similarity.pkl','rb'))
...
image = Image.open('C:\\Users\\user\\Desktop\\medi\\medicine-recommendation-system\\images\\medicine-image.jpg')
